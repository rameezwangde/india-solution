      ...
      <div className="container relative z-10 mx-auto px-6 lg:px-12 max-w-[1300px]">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 lg:gap-8 mb-12">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-[#2A1810] text-[11.5px] font-medium leading-relaxed mb-6">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-[12px] text-[#4A2F1D] font-bold tracking-widest mb-3">QUICK LINKS</h4>
            ...
            <ul className="space-y-3.5">
              <li><Link to="/about" className="text-[#2A1810] font-medium hover:text-[#4A2F1D] text-[12px] transition-colors">About Us</Link></li>
              <li><Link to="/services" className="text-[#2A1810] font-medium hover:text-[#4A2F1D] text-[12px] transition-colors">Our Services</Link></li>
              <li><Link to="/gallery" className="text-[#2A1810] font-medium hover:text-[#4A2F1D] text-[12px] transition-colors">Gallery</Link></li>
              <li><Link to="/why-choose-us" className="text-[#2A1810] font-medium hover:text-[#4A2F1D] text-[12px] transition-colors">Why Choose Us</Link></li>
              <li><Link to="/contact" className="text-[#2A1810] font-medium hover:text-[#4A2F1D] text-[12px] transition-colors">Contact Us</Link></li>
            </ul>
          </div>

          {/* Services */}
          <div>
            <h4 className="text-[12px] text-[#4A2F1D] font-bold tracking-widest mb-3">OUR SERVICES</h4>
            <div className="flex items-center gap-2 mb-6">
              <span className="h-[1px] w-4 bg-[#D5C5B9]" />
              <span className="text-[#4A2F1D] text-[10px]">❖</span>
              <span className="h-[1px] w-4 bg-[#D5C5B9]" />
            ...
            <ul className="space-y-3.5">
              <li><Link to="/services" className="text-[#2A1810] font-medium hover:text-[#4A2F1D] text-[12px] transition-colors">Corporate Events</Link></li>
              <li><Link to="/services" className="text-[#2A1810] font-medium hover:text-[#4A2F1D] text-[12px] transition-colors">Weddings & Pre-Wedding</Link></li>
              <li><Link to="/services" className="text-[#2A1810] font-medium hover:text-[#4A2F1D] text-[12px] transition-colors">Trade Shows</Link></li>
              <li><Link to="/services" className="text-[#2A1810] font-medium hover:text-[#4A2F1D] text-[12px] transition-colors">Birthday Parties</Link></li>
              <li><Link to="/services" className="text-[#2A1810] font-medium hover:text-[#4A2F1D] text-[12px] transition-colors">Special Entries</Link></li>
            </ul>
          </div>

          {/* Contact */}
          <div>
            <h4 className="text-[12px] text-[#4A2F1D] font-bold tracking-widest mb-3">CONTACT INFO</h4>
            <div className="flex items-center gap-2 mb-6">
              <span className="h-[1px] w-4 bg-[#D5C5B9]" />
              <span className="text-[#4A2F1D] text-[10px]">❖</span>
              <span className="h-[1px] w-4 bg-[#D5C5B9]" />
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-[#2A1810] font-medium text-[12px] mt-0.5">Bengaluru, Karnataka, India</span>
              </li>
              <li className="flex items-center gap-3">
                ...
                <span className="text-[#2A1810] font-medium text-[12px]">+91 6360181932</span>
              </li>
              <li className="flex items-center gap-3">
                <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full border border-[#D5C5B9]">
                  <Mail size={10} className="text-[#4A2F1D]" />
                </div>
                <span className="text-[#2A1810] font-medium text-[12px]">info@india-solution.com</span>
              </li>
            </ul>
          </div>
        ...
        <div className="pt-6 mt-4 relative text-center flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-[#4A2F1D] text-[11px] font-medium">
            © {new Date().getFullYear()} India Solution Events. All rights reserved.
          </p>
          <div className="flex gap-4">
            <Link to="/privacy" className="text-[#4A2F1D] hover:text-[#4A2F1D] text-[11px] font-medium transition-colors">Privacy Policy</Link>
            <span className="text-[#D5C5B9]">|</span>
            <Link to="/terms" className="text-[#4A2F1D] hover:text-[#4A2F1D] text-[11px] font-medium transition-colors">Terms of Service</Link>
          </div>
        </div>
      </div>
    </footer>
