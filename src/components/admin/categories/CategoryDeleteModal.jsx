  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        >
          <button onClick={onClose} disabled={isDeleting || isDeactivating} className="absolute top-4 right-4 text-gray-400 hover:text-white transition-colors disabled:opacity-50">
            <X size={20} />
          </button>
          ...
          <div className="flex flex-col items-center text-center">
            {hasProducts ? (
              <>
                ...
                <h3 className="text-xl font-bold text-white mb-2">Deletion Blocked</h3>
                <div className="text-gray-400 text-sm mb-6 space-y-2">
                  <p>
                    <span className="text-white font-medium">{category.name}</span> cannot be deleted because <strong className="text-orange-400">{category.productCount} {category.productCount === 1 ? 'product is' : 'products are'}</strong> linked to it.
                  </p>
                  <p>
                ...
                <div className="flex w-full gap-3 flex-col sm:flex-row">
                  ...
                  <button
                    ...
                    className="flex-1 px-4 py-2 bg-orange-500 hover:bg-orange-600 text-white rounded-lg transition-colors font-medium flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
              ...
              <>
                ...
                <p className="text-gray-400 text-sm mb-6">
                  Are you sure you want to delete <span className="text-white font-medium">{category.name}</span>? 
