    ...
    <div className="space-y-6 pb-20">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-[#4A2F1D]">View and manage stock specific to each department.</p>
        </div>
        ...
        <div className="flex items-center gap-4 bg-white shadow-sm border border-[#E8DFD5] p-3 rounded-xl">
          <div className="text-sm">
            <span className="text-[#4A2F1D] font-semibold uppercase tracking-wider text-[11px]">Total Unique: </span>
            <span className="text-[#4A2F1D] font-bold text-lg">{totals.products}</span>
          </div>
          <div className="w-px h-8 bg-[#E8DFD5]"></div>
          <div className="text-sm">
            <span className="text-[#4A2F1D] font-semibold uppercase tracking-wider text-[11px]">Total Items: </span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
              ...
              <div className="p-6 flex-grow">
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="bg-[#FAF7F2] rounded-xl p-4">
                    <div className="text-[#4A2F1D] text-xs uppercase tracking-wider mb-1">Products</div>
                    <div className="text-2xl font-bold text-[#4A2F1D]">{dept.totalProducts}</div>
                  </div>
                  <div className="bg-[#FAF7F2] rounded-xl p-4">
                    <div className="text-[#4A2F1D] text-xs uppercase tracking-wider mb-1">Total Qty</div>
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center text-sm">
                    <span className="text-[#4A2F1D]">In Stock</span>
                    <span className="text-green-400 font-medium">{dept.inStock}</span>
                  </div>
                  <div className="flex justify-between items-center text-sm">
                    <span className="text-[#4A2F1D]">Low Stock</span>
                    <span className="text-[#C0602F]-400 font-medium">{dept.lowStock}</span>
                  </div>
                  <div className="flex justify-between items-center text-sm">
                    <span className="text-[#4A2F1D]">Out of Stock</span>
                ...
                <div className="flex justify-between items-center text-sm">
                  <span className="text-[#4A2F1D]">Active / Inactive</span>
                  <span className="text-[#4A2F1D]">{dept.activeProducts} / {dept.inactiveProducts}</span>
                </div>
              </div>
        ...
        {departments.length === 0 && (
          <div className="col-span-full py-12 text-center bg-[#FAF7F2] rounded-2xl border border-[#E8DFD5]">
            <Box size={48} className="mx-auto text-[#4A2F1D] mb-4" />
            <h3 className="text-xl font-bold text-[#4A2F1D] mb-2">No Departments Found</h3>
            <p className="text-[#4A2F1D] mb-6">Import inventory or create products to see departments here.</p>
              ...
              <div className="p-6">
                ...
                <div className="flex justify-end gap-3">
                  <button
                    ...
                    disabled={isDeleting}
                    className="px-5 py-2.5 rounded-xl text-[#4A2F1D] hover:bg-[#FAF7F2] hover:text-[#4A2F1D] transition-colors font-medium disabled:opacity-50"
                  >
                    Cancel
                  </button>
                  <button
