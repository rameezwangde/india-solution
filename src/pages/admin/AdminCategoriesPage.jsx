  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard title="With Products" value={stats.withProducts} icon={Box} color="bg-orange-500/20 text-[#C0602F]-500" />
      </div>
                ...
                {loading ? (
                  Array.from({ length: 3 }).map((_, i) => (
                    <tr key={i} className="animate-pulse">
                      <td className="px-6 py-4"><div className="h-6 w-32 bg-[#FAF7F2] rounded"></div></td>
                      <td className="px-6 py-4"><div className="h-4 w-24 bg-[#FAF7F2] rounded"></div></td>
                      <td className="px-6 py-4"><div className="h-4 w-48 bg-[#FAF7F2] rounded"></div></td>
                      <td className="px-6 py-4 text-center"><div className="h-6 w-8 bg-[#FAF7F2] rounded-full mx-auto"></div></td>
                      <td className="px-6 py-4"><div className="h-6 w-16 bg-[#FAF7F2] rounded-full"></div></td>
             ...
             {loading ? (
                Array.from({ length: 3 }).map((_, i) => (
                  <div key={i} className="p-4 animate-pulse space-y-3">
                    <div className="h-5 bg-[#FAF7F2] rounded w-1/2"></div>
                ...
                categories.map(c => (
                  <div key={c._id} className={`p-4 flex flex-col gap-3 ${!c.isActive ? 'opacity-70 bg-black/10' : ''}`}>
                    ...
                    <div className="grid grid-cols-3 gap-2 pt-3 border-t border-[#E8DFD5]">
                      ...
                      <button onClick={() => openForm(c)} className="flex flex-col items-center justify-center py-2.5 bg-[#FAF7F2] rounded-lg text-blue-400 text-xs gap-1">
                        <Edit size={16} /> Edit
                      </button>
